...
2. Join the session (called `ICML2020 - M2`) by clicking this link: `link comming soon`.

The session will be public, so you can also find it in the Neos Session browser.
